// Package main
// Generated by sql2struct at 2024-03-09 16:10:50
package main

import "time"

// Products Generated by sql2struct at 2024-03-09 16:10:50
...
// Goods 商品表
// Generated by sql2struct at 2024-03-09 16:10:51
type Goods struct {
...
// Commodity Generated by sql2struct at 2024-03-09 16:10:51
type Commodity struct {
    Id uint32 `gorm:"column:f_id" json:"f_id" db:"f_id" form:"id" sql:"f_id" xorm:"f_id"` // 商品id
    Name string `gorm:"column:f_name" json:"f_name" db:"f_name" form:"name" sql:"f_name" xorm:"f_name"` // 商品名称
    Description string `gorm:"column:f_description" json:"f_description" db:"f_description" form:"description" sql:"f_description" xorm:"f_description"`
    Price float64 `gorm:"column:f_price" json:"f_price" db:"f_price" form:"price" sql:"f_price" xorm:"f_price"`
    Weight float32 `gorm:"column:f_weight" json:"f_weight" db:"f_weight" form:"weight" sql:"f_weight" xorm:"f_weight"` // 商品重量（kg）
    Quantity uint32 `gorm:"column:f_quantity" json:"f_quantity" db:"f_quantity" form:"quantity" sql:"f_quantity" xorm:"f_quantity"` // 商品库存数量
    IsActive int32 `gorm:"column:f_is_active" json:"f_is_active" db:"f_is_active" form:"is_active" sql:"f_is_active" xorm:"f_is_active"` // 商品是否激活（0 - 未激活，1 - 激活）
    Rating float64 `gorm:"column:f_rating" json:"f_rating" db:"f_rating" form:"rating" sql:"f_rating" xorm:"f_rating"` // 商品评分
    CreatedAt time.Time `gorm:"column:f_created_at" json:"f_created_at" db:"f_created_at" form:"created_at" sql:"f_created_at" xorm:"f_created_at"` // 商品创建时间
    UpdatedAt time.Time `gorm:"column:f_updated_at" json:"f_updated_at" db:"f_updated_at" form:"updated_at" sql:"f_updated_at" xorm:"f_updated_at"` // 商品更新时间
}
